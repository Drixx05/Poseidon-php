...
SELECT AVG(salaire) AS salaire_moyen_1517 FROM employes WHERE date_embauche BETWEEN '2015-01-01' AND '2017-12-31';
SELECT AVG(salaire) AS salaire_moyen_1517 FROM employes WHERE YEAR(date_embauche) BETWEEN 2015 AND 2017;
+--------------------+
| salaire_moyen_1517 |
+--------------------+
|               2555 |
...
SELECT COUNT(*) AS nbr, sexe FROM employes GROUP BY sexe;
+-----+------+
| nbr | sexe |
+-----+------+
|  11 | m    |
...
SELECT nom, prenom, salaire + 100 AS nouveau_salaire FROM employes;
