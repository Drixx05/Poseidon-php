...
-- Créer les comptes utilisateur suivants : 
        ...
        CREATE USER "secretaire"@"localhost" IDENTIFIED BY "secretaire";
        ...
        CREATE USER "directeur"@"localhost" IDENTIFIED BY "directeur";
        ...
        CREATE USER "informaticien"@"localhost" IDENTIFIED BY "informaticien"
...
-- Déconnectez vous du compte root, et connectez vous en tant que secrétaire et répondre aux requêtes suivantes : 
            ...
            -- ERROR 1142 (42000): La commande 'UPDATE' est interdite à l'utilisateur: 'secretaire'@'@localhost' sur la table 'employes'
